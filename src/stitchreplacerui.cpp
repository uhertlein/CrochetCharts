    ...
    , ui(new Ui::StitchReplacerUi)
{
    ...
    connect(ui->originalStitch, SIGNAL(currentIndexChanged(QString)),
            SLOT(updateStitches(QString)));
    connect(ui->replacementStitch, SIGNAL(currentIndexChanged(QString)),
            SLOT(updateStitches(QString)));
...
void
StitchReplacerUi::updateStitches(QString newStitch)
{
...
void
StitchReplacerUi::populateStitchLists()
{
