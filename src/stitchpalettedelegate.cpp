...
void
StitchPaletteDelegate::paint(QPainter* painter,
                             ...
                             const QModelIndex& index) const
{
    ...
    else if (index.column() == 1)
    {
        ...
        QPixmap pix = (s->renderPixmap()->scaled(size, size, Qt::KeepAspectRatio,
...
QSize
StitchPaletteDelegate::sizeHint(const QStyleOptionViewItem& option, const QModelIndex& index) const
{
    Q_UNUSED(option);
