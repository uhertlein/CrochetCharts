...
void
ColorListWidget::mousePressEvent(QMouseEvent* event)
{
...
void
ColorListWidget::mouseMoveEvent(QMouseEvent* e)
{
...
QPixmap
ColorListWidget::drawColorBox(QColor color, QSize size)
{
...
void
ColorListWidget::dragEnterEvent(QDragEnterEvent* e)
{
