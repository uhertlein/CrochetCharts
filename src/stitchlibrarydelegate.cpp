...
/***************************************************************************************************************/
static QRect
CheckBoxRect(const QStyleOptionViewItem& itemStyleOptions)
{
    ...
    QPoint check_box_point(
        itemStyleOptions.rect.x() + itemStyleOptions.rect.width() / 2 - rect.width() / 2,
...
void
StitchLibraryDelegate::paint(QPainter* painter,
...
QSize
StitchLibraryDelegate::sizeHint(const QStyleOptionViewItem& option, const QModelIndex& index) const
{
    int padding = 0;
...
QWidget*
StitchLibraryDelegate::createEditor(QWidget* parent,
                                    const QStyleOptionViewItem& option,
                                    const QModelIndex& index) const
{
    Q_UNUSED(option);
...
void
StitchLibraryDelegate::setEditorData(QWidget* editor, const QModelIndex& index) const
{
    if (!index.isValid())
        return;
...
void
StitchLibraryDelegate::setModelData(QWidget* editor,
...
void
StitchLibraryDelegate::updateEditorGeometry(QWidget* editor,
                                            const QStyleOptionViewItem& option,
                                            const QModelIndex& index) const
{
    Q_UNUSED(index);
...
bool
StitchLibraryDelegate::editorEvent(QEvent* event,
                                   QAbstractItemModel* model,
                                   const QStyleOptionViewItem& option,
...
void
StitchLibraryDelegate::loadIcons(QComboBox* cb) const
{
