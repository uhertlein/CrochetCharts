...
public:
    ...
    /**
     * rotate a point in local coordinates (boundingrect coordinates) with the rotation of the
     * graphicsitem
     */
    static QPointF mapToRotation(QGraphicsItem* item, QPointF point);
    /**
     * scale a point in local coordinates (boundingrect coordinates) with the rotation of the
     * graphicsitem
     */
    static QPointF mapToScale(QGraphicsItem* item, QPointF point);
    /**
     * rotate and scale a point in local coordinates (boundingrect coordinates) with the data of the
     * item
     */
