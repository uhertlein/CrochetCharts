...
void
AbstractSelectionBand::setDefaultStyle(QPainter& p)
{
...
void
AbstractSelectionBand::setPosition(const QPoint& pos)
{
    mPosition = pos;
}
...
void
RubberBand::moveMouseTo(const QPointF& pos)
{
    mMouseNow = pos;
    updatePath();
}
...
void
LassoBand::moveMouseTo(const QPointF& pos)
{
    mMouseNow = pos;
    updatePath();
}
...
void
LineBand::moveMouseTo(const QPointF& pos)
{
    mMouseNow = pos;
    updatePath();
}
