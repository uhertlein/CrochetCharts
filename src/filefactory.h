...
public:
    ...
    /**
     * @brief isOldFileVersion - tells the software that the file loaded was from a previous
     * savefile version.
     *
     * If the save file is old we want to offer a choice to the user of updating the save file
     * version. And also to remember to save to the correct file version.
     *
